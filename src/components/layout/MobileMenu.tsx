...
const subcategoryIconMap: Record<string, any> = {
  ...
  'astronomy-science': Rocket,
  'biology-science': HeartPulse,
  'environmental-science': Droplets,
  'material-science': HardDrive,
...
const calculatorIconMap: Record<string, any> = {
  ...
  'acceleration-calculator': Rocket,
  'displacement-calculator': ArrowLeftRight,
  'kinematic-distance-calculator': Ruler,
  'kinematic-time-calculator': Clock,
  'final-velocity-calculator': FastForward,
  'initial-velocity-calculator': ChevronLeft,
  'equation-of-motion-calculator': Activity,
  'free-fall-calculator': TrendingDown,
  'projectile-motion': Rocket,
  'time-of-flight-calculator': Clock,

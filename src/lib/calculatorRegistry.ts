...
export const calculatorComponents: Record<string, any> = {
  ...
  'calorie-calculator': dynamic(() => import('@/components/calculators/categories/health/AdvancedNutritionCalculators').then(m => ({ default: m.AdvancedCalorieCalculatorV2 }))),
  'ideal-weight-calculator': dynamic(() => import('@/components/calculators/categories/health/AdvancedWeightGoalCalculators2').then(m => ({ default: m.AdvancedIdealWeightCalculator }))),
  'macro-calculator': dynamic(() => import('@/components/calculators/categories/health/AdvancedNutritionCalculators').then(m => ({ default: m.AdvancedMacroCalculatorV2 }))),
  'tdee-calculator': dynamic(() => import('@/components/calculators/categories/health/AdvancedNutritionCalculators').then(m => ({ default: m.AdvancedTDEECalculatorV2 }))),
  'water-intake-calculator': dynamic(() => import('@/components/calculators/categories/health/AdvancedNutritionCalculators').then(m => ({ default: m.AdvancedWaterIntakeCalculatorV2 }))),
  ...
  // Health - Nutrition & Calorie Tracking (ADVANCED CALCULATORS)
  'meal-planner': dynamic(() => import('@/components/calculators/categories/health/AdvancedNutritionCalculators').then(m => ({ default: m.AdvancedMealPlannerCalculator }))),
  'glycemic-index-calculator': dynamic(() => import('@/components/calculators/categories/health/AdvancedNutritionCalculators').then(m => ({ default: m.AdvancedGlycemicIndexCalculator }))),
  'glycemic-load-calculator': dynamic(() => import('@/components/calculators/categories/health/AdvancedNutritionCalculators').then(m => ({ default: m.AdvancedGlycemicLoadCalculator }))),
  'fiber-intake-calculator': dynamic(() => import('@/components/calculators/categories/health/AdvancedNutritionCalculators').then(m => ({ default: m.AdvancedFiberIntakeCalculator }))),
  'sugar-intake-calculator': dynamic(() => import('@/components/calculators/categories/health/AdvancedNutritionCalculators').then(m => ({ default: m.AdvancedSugarIntakeCalculator }))),
  'sodium-intake-calculator': dynamic(() => import('@/components/calculators/categories/health/AdvancedNutritionCalculators').then(m => ({ default: m.AdvancedSodiumIntakeCalculator }))),
  'fat-intake-calculator': dynamic(() => import('@/components/calculators/categories/health/AdvancedNutritionMetabolicSuite').then(m => ({ default: m.AdvancedFatIntakeCalculator }))),
  'carb-calculator': dynamic(() => import('@/components/calculators/categories/health/AdvancedNutritionMetabolicSuite').then(m => ({ default: m.AdvancedCarbCalculator }))),
  'vitamin-d-calculator': dynamic(() => import('@/components/calculators/categories/health/AdvancedNutritionMetabolicSuite').then(m => ({ default: m.AdvancedVitaminDCalculator }))),
  'iron-intake-calculator': dynamic(() => import('@/components/calculators/categories/health/AdvancedNutritionMetabolicSuite').then(m => ({ default: m.AdvancedIronIntakeCalculator }))),
  'hydration-electrolyte-calculator': dynamic(() => import('@/components/calculators/categories/health/AdvancedNutritionMetabolicSuite').then(m => ({ default: m.AdvancedHydrationElectrolyteCalculator }))),
  'keto-macro-calculator': dynamic(() => import('@/components/calculators/categories/health/AdvancedNutritionMetabolicSuite').then(m => ({ default: m.AdvancedKetoMacroCalculator }))),
  'intermittent-fasting-window': dynamic(() => import('@/components/calculators/categories/health/AdvancedNutritionMetabolicSuite').then(m => ({ default: m.AdvancedIntermittentFastingWindowCalculator }))),
  'meal-calorie-breakdown': dynamic(() => import('@/components/calculators/categories/health/AdvancedNutritionMetabolicSuite').then(m => ({ default: m.AdvancedMealCalorieBreakdownCalculator }))),
  'nutrition-label-calculator': dynamic(() => import('@/components/calculators/categories/health/AdvancedNutritionMetabolicSuite').then(m => ({ default: m.AdvancedNutritionLabelCalculator }))),
  'omega3-intake-calculator': dynamic(() => import('@/components/calculators/categories/health/AdvancedNutritionMetabolicSuite').then(m => ({ default: m.AdvancedOmega3IntakeCalculator }))),
  'calcium-intake-calculator': dynamic(() => import('@/components/calculators/categories/health/AdvancedNutritionMetabolicSuite').then(m => ({ default: m.AdvancedCalciumIntakeCalculator }))),
  'magnesium-intake': dynamic(() => import('@/components/calculators/categories/health/AdvancedNutritionMetabolicSuite').then(m => ({ default: m.AdvancedMagnesiumIntakeEstimator }))),
  'potassium-intake': dynamic(() => import('@/components/calculators/categories/health/AdvancedNutritionMetabolicSuite2').then(m => ({ default: m.AdvancedPotassiumIntakeCalculator }))),
  'zinc-intake-calculator': dynamic(() => import('@/components/calculators/categories/health/AdvancedNutritionMetabolicSuite2').then(m => ({ default: m.AdvancedZincIntakeCalculator }))),
  'vitamin-c-intake': dynamic(() => import('@/components/calculators/categories/health/AdvancedNutritionMetabolicSuite2').then(m => ({ default: m.AdvancedVitaminCIntakeEstimator }))),
  'vitamin-b12-intake': dynamic(() => import('@/components/calculators/categories/health/AdvancedNutritionMetabolicSuite2').then(m => ({ default: m.AdvancedVitaminB12Calculator }))),
  'folate-intake-calculator': dynamic(() => import('@/components/calculators/categories/health/AdvancedNutritionMetabolicSuite2').then(m => ({ default: m.AdvancedFolateIntakeCalculator }))),
  'protein-timing-calculator': dynamic(() => import('@/components/calculators/categories/health/AdvancedNutritionMetabolicSuite2').then(m => ({ default: m.AdvancedProteinTimingOptimizer }))),
  'pre-workout-nutrition': dynamic(() => import('@/components/calculators/categories/health/AdvancedNutritionMetabolicSuite2').then(m => ({ default: m.AdvancedPreWorkoutNutritionPlanner }))),
  'post-workout-nutrition': dynamic(() => import('@/components/calculators/categories/health/AdvancedNutritionMetabolicSuite2').then(m => ({ default: m.AdvancedPostWorkoutNutritionGuide }))),
  'meal-frequency-calculator': dynamic(() => import('@/components/calculators/categories/health/AdvancedNutritionMetabolicSuite2').then(m => ({ default: m.AdvancedMealFrequencyCalculator }))),
  'portion-size-calculator': dynamic(() => import('@/components/calculators/categories/health/AdvancedNutritionMetabolicSuite2').then(m => ({ default: m.AdvancedPortionSizeCalculator }))),
  'micronutrient-tracker': dynamic(() => import('@/components/calculators/categories/health/AdvancedNutritionMetabolicSuite2').then(m => ({ default: m.AdvancedMicronutrientTracker }))),
  ...
  'caffeine-half-life': dynamic(() => import('@/components/calculators/categories/health/AdvancedNutritionMetabolicSuite3').then(m => ({ default: m.AdvancedCaffeineHalfLifeCalculator }))),
  'creatine-intake': dynamic(() => import('@/components/calculators/categories/health/AdvancedNutritionMetabolicSuite3').then(m => ({ default: m.AdvancedCreatineIntakeCalculator }))),
  'beta-alanine-dosage': dynamic(() => import('@/components/calculators/categories/health/AdvancedNutritionMetabolicSuite3').then(m => ({ default: m.AdvancedBetaAlanineDosage }))),
  'citrulline-malate': dynamic(() => import('@/components/calculators/categories/health/AdvancedNutritionMetabolicSuite3').then(m => ({ default: m.AdvancedCitrullineMalateDosage }))),
  'bcaa-dosage': dynamic(() => import('@/components/calculators/categories/health/AdvancedNutritionMetabolicSuite3').then(m => ({ default: m.AdvancedBCAADosageCalculator }))),
  'alcohol-calorie-calculator': dynamic(() => import('@/components/calculators/categories/health/AdvancedNutritionMetabolicSuite3').then(m => ({ default: m.AdvancedAlcoholCalorieCalculator }))),
  'eating-window-16-8': dynamic(() => import('@/components/calculators/categories/health/AdvancedNutritionMetabolicSuite3').then(m => ({ default: m.AdvancedEatingWindow168Calculator }))),
  'carb-cycling-planner': dynamic(() => import('@/components/calculators/categories/health/AdvancedNutritionMetabolicSuite3').then(m => ({ default: m.AdvancedCarbCyclingPlanner }))),
  'paleo-macro-calculator': dynamic(() => import('@/components/calculators/categories/health/AdvancedNutritionMetabolicSuite3').then(m => ({ default: m.AdvancedPaleoMacroCalculator }))),
  'vegan-protein-calculator': dynamic(() => import('@/components/calculators/categories/health/AdvancedNutritionMetabolicSuite3').then(m => ({ default: m.AdvancedVeganProteinCalculator }))),
  'nutrient-density-score': dynamic(() => import('@/components/calculators/categories/health/AdvancedNutritionMetabolicSuite3').then(m => ({ default: m.AdvancedNutrientDensityScore }))),
  'eaa-dosage': dynamic(() => import('@/components/calculators/categories/health/AdvancedNutritionMetabolicSuite4').then(m => ({ default: m.AdvancedEAADosageCalculator }))),
  'glutamine-dosage': dynamic(() => import('@/components/calculators/categories/health/AdvancedNutritionMetabolicSuite4').then(m => ({ default: m.AdvancedGlutamineDosageCalculator }))),
  'leucine-threshold': dynamic(() => import('@/components/calculators/categories/health/AdvancedNutritionMetabolicSuite4').then(m => ({ default: m.AdvancedLeucineThresholdCalculator }))),
  'casein-protein': dynamic(() => import('@/components/calculators/categories/health/AdvancedNutritionMetabolicSuite4').then(m => ({ default: m.AdvancedCaseinProteinCalculator }))),
  'whey-protein': dynamic(() => import('@/components/calculators/categories/health/AdvancedNutritionMetabolicSuite4').then(m => ({ default: m.AdvancedWheyProteinCalculator }))),
  'plant-protein': dynamic(() => import('@/components/calculators/categories/health/AdvancedNutritionMetabolicSuite4').then(m => ({ default: m.AdvancedPlantProteinCalculator }))),
  'collagen-dosage': dynamic(() => import('@/components/calculators/categories/health/AdvancedNutritionMetabolicSuite4').then(m => ({ default: m.AdvancedCollagenDosageCalculator }))),
  'electrolyte-balance': dynamic(() => import('@/components/calculators/categories/health/AdvancedNutritionMetabolicSuite4').then(m => ({ default: m.AdvancedElectrolyteBalanceCalculator }))),
  'post-bariatric-protein': dynamic(() => import('@/components/calculators/categories/health/AdvancedNutritionMetabolicSuite4').then(m => ({ default: m.AdvancedPostBariatricProteinCalculator }))),
  'toddler-calorie': dynamic(() => import('@/components/calculators/categories/health/AdvancedNutritionMetabolicSuite4').then(m => ({ default: m.AdvancedToddlerCalorieCalculator }))),
  ...
  'hiit-workout-calculator': dynamic(() => import('@/components/calculators/categories/health/AdvancedExercisePerformanceCalculators3').then(m => ({ default: m.AdvancedHIITCalculator }))),
  'steps-to-calories': dynamic(() => import('@/components/calculators/categories/health/AdvancedExercisePerformanceCalculators2').then(m => ({ default: m.AdvancedStepsToCaloriesCalculator }))),
  'yoga-calories-calculator': dynamic(() => import('@/components/calculators/categories/health/AdvancedExercisePerformanceCalculators3').then(m => ({ default: m.YogaCaloriesCalculator }))),
  'pilates-calorie-burn': dynamic(() => import('@/components/calculators/categories/health/AdvancedExercisePerformanceCalculators3').then(m => ({ default: m.PilatesCalorieBurnCalculator }))),
  'jump-rope-calculator': dynamic(() => import('@/components/calculators/categories/health/AdvancedExercisePerformanceCalculators3').then(m => ({ default: m.JumpRopeCalculator }))),
  'grip-strength': dynamic(() => import('@/components/calculators/categories/health/AdvancedExercisePerformanceCalculators3').then(m => ({ default: m.GripStrengthCalculator }))),
  'vertical-jump': dynamic(() => import('@/components/calculators/categories/health/AdvancedExercisePerformanceCalculators3').then(m => ({ default: m.VerticalJumpCalculator }))),
  'broad-jump': dynamic(() => import('@/components/calculators/categories/health/AdvancedExercisePerformanceCalculators3').then(m => ({ default: m.BroadJumpCalculator }))),
  'shuttle-run': dynamic(() => import('@/components/calculators/categories/health/AdvancedExercisePerformanceCalculators3').then(m => ({ default: m.ShuttleRunCalculator }))),
  'beep-test': dynamic(() => import('@/components/calculators/categories/health/AdvancedExercisePerformanceCalculators3').then(m => ({ default: m.BeepTestCalculator }))),
  'yo-yo-test': dynamic(() => import('@/components/calculators/categories/health/AdvancedExercisePerformanceCalculators3').then(m => ({ default: m.YoYoTestCalculator }))),
  'navy-seal-pst': dynamic(() => import('@/components/calculators/categories/health/AdvancedExercisePerformanceCalculators3').then(m => ({ default: m.NavySealPSTCalculator }))),
  'bench-press-calculator': dynamic(() => import('@/components/calculators/categories/health/AdvancedExercisePerformanceCalculators6').then(m => ({ default: m.AdvancedBenchPressCalculator }))),
  ...
  'lactate-threshold': dynamic(() => import('@/components/calculators/categories/health/AdvancedExercisePerformanceCalculators2').then(m => ({ default: m.LactateThresholdCalculator }))),
  'rpe-calculator': dynamic(() => import('@/components/calculators/categories/health/AdvancedExercisePerformanceCalculators2').then(m => ({ default: m.RPECalculator }))),
  'power-to-weight': dynamic(() => import('@/components/calculators/categories/health/AdvancedExercisePerformanceCalculators4').then(m => ({ default: m.AdvancedPowerToWeightCalculator }))),
  'ftp-calculator': dynamic(() => import('@/components/calculators/categories/health/AdvancedExercisePerformanceCalculators4').then(m => ({ default: m.AdvancedFTPCalculator }))),
  'maf-180': dynamic(() => import('@/components/calculators/categories/health/AdvancedHeartHealthCalculators3').then(m => ({ default: m.AdvancedMAF180Calculator }))),
  'cooper-test-calculator': dynamic(() => import('@/components/calculators/categories/health/AdvancedExercisePerformanceCalculators6').then(m => ({ default: m.AdvancedCooperTestCalculator }))),
  'army-acft': dynamic(() => import('@/components/calculators/categories/health/AdvancedExercisePerformanceCalculators4').then(m => ({ default: m.ArmyACFTCalculator }))),
  'marine-pft': dynamic(() => import('@/components/calculators/categories/health/AdvancedExercisePerformanceCalculators4').then(m => ({ default: m.MarinePFTCalculator }))),
  'air-force-pfa': dynamic(() => import('@/components/calculators/categories/health/AdvancedExercisePerformanceCalculators4').then(m => ({ default: m.AirForcePFACalculator }))),
  'firefighter-cpat': dynamic(() => import('@/components/calculators/categories/health/AdvancedExercisePerformanceCalculators4').then(m => ({ default: m.FirefighterCPATCalculator }))),
  'police-fitness': dynamic(() => import('@/components/calculators/categories/health/AdvancedExercisePerformanceCalculators4').then(m => ({ default: m.PoliceFitnessCalculator }))),
  'tss-calculator': dynamic(() => import('@/components/calculators/categories/health/AdvancedExercisePerformanceCalculators4').then(m => ({ default: m.TSSCalculator }))),
  'if-calculator': dynamic(() => import('@/components/calculators/categories/health/AdvancedExercisePerformanceCalculators4').then(m => ({ default: m.IFCalculator }))),
  'swim-pace': dynamic(() => import('@/components/calculators/categories/health/AdvancedExercisePerformanceCalculators4').then(m => ({ default: m.SwimPaceCalculator }))),
  'triathlon-time': dynamic(() => import('@/components/calculators/categories/health/AdvancedExercisePerformanceCalculators4').then(m => ({ default: m.TriathlonTimePredictor }))),
  'marathon-time': dynamic(() => import('@/components/calculators/categories/health/AdvancedExercisePerformanceCalculators5').then(m => ({ default: m.MarathonTimePredictor }))),
  'half-marathon-time': dynamic(() => import('@/components/calculators/categories/health/AdvancedExercisePerformanceCalculators5').then(m => ({ default: m.HalfMarathonPredictor }))),
  '5k-time': dynamic(() => import('@/components/calculators/categories/health/AdvancedExercisePerformanceCalculators5').then(m => ({ default: m.FiveKTimePredictor }))),
  '10k-time': dynamic(() => import('@/components/calculators/categories/health/AdvancedExercisePerformanceCalculators5').then(m => ({ default: m.TenKTimePredictor }))),
  'rowing-calories-burned': dynamic(() => import('@/components/calculators/categories/health/AdvancedExercisePerformanceCalculators5').then(m => ({ default: m.RowingCaloriesCalculator }))),
  'stair-climbing-calories': dynamic(() => import('@/components/calculators/categories/health/AdvancedExercisePerformanceCalculators5').then(m => ({ default: m.StairClimbingCaloriesCalculator }))),
  'elliptical-calories': dynamic(() => import('@/components/calculators/categories/health/AdvancedExercisePerformanceCalculators5').then(m => ({ default: m.EllipticalCaloriesCalculator }))),
  'boxing-calories-burned': dynamic(() => import('@/components/calculators/categories/health/AdvancedExercisePerformanceCalculators5').then(m => ({ default: m.BoxingCaloriesCalculator }))),
  'dance-calories-calculator': dynamic(() => import('@/components/calculators/categories/health/AdvancedExercisePerformanceCalculators5').then(m => ({ default: m.DanceCaloriesCalculator }))),
  'rock-climbing-calories': dynamic(() => import('@/components/calculators/categories/health/AdvancedExercisePerformanceCalculators5').then(m => ({ default: m.RockClimbingCaloriesCalculator }))),
  'tennis-calories-burned': dynamic(() => import('@/components/calculators/categories/health/AdvancedExercisePerformanceCalculators5').then(m => ({ default: m.TennisCaloriesCalculator }))),
  'basketball-calories': dynamic(() => import('@/components/calculators/categories/health/AdvancedExercisePerformanceCalculators6').then(m => ({ default: m.BasketballCaloriesCalculator }))),
  'soccer-calories-burned': dynamic(() => import('@/components/calculators/categories/health/AdvancedExercisePerformanceCalculators6').then(m => ({ default: m.SoccerCaloriesCalculator }))),
  'golf-calories-calculator': dynamic(() => import('@/components/calculators/categories/health/AdvancedExercisePerformanceCalculators6').then(m => ({ default: m.GolfCaloriesCalculator }))),

  // ─── Health - Heart & Vital Health ─────────────────────────────────────────
  'blood-pressure-calculator': dynamic(() => import('@/components/calculators/categories/health/AdvancedHeartHealthCalculators2').then(m => ({ default: m.AdvancedBloodPressureCalculator }))),
  'resting-heart-rate': dynamic(() => import('@/components/calculators/categories/health/AdvancedHeartHealthCalculators2').then(m => ({ default: m.AdvancedRestingHeartRateCalculator }))),
  'pulse-pressure-calculator': dynamic(() => import('@/components/calculators/categories/health/AdvancedHeartHealthCalculators2').then(m => ({ default: m.AdvancedPulsePressureCalculator }))),
  'mean-arterial-pressure': dynamic(() => import('@/components/calculators/categories/health/AdvancedHeartHealthCalculators2').then(m => ({ default: m.AdvancedMAPCalculator }))),
  'cardiac-output-calculator': dynamic(() => import('@/components/calculators/categories/health/AdvancedHeartHealthCalculators2').then(m => ({ default: m.AdvancedCardiacOutputCalculator }))),
  'heart-age-calculator': dynamic(() => import('@/components/calculators/categories/health/AdvancedHeartHealthCalculators2').then(m => ({ default: m.AdvancedHeartAgeCalculator }))),
  'blood-volume-calculator': dynamic(() => import('@/components/calculators/categories/health/AdvancedHeartHealthCalculators2').then(m => ({ default: m.AdvancedBloodVolumeCalculator }))),
  'oxygen-saturation-interpreter': dynamic(() => import('@/components/calculators/categories/health/AdvancedHeartHealthCalculators2').then(m => ({ default: m.AdvancedOxygenSaturationInterpreter }))),
  'qt-interval-calculator': dynamic(() => import('@/components/calculators/categories/health/AdvancedHeartHealthCalculators4').then(m => ({ default: m.AdvancedQTIntervalCalculator }))),
  'stroke-volume-calculator': dynamic(() => import('@/components/calculators/categories/health/AdvancedHeartHealthCalculators4').then(m => ({ default: m.AdvancedStrokeVolumeCalculator }))),
  'ankle-brachial-index': dynamic(() => import('@/components/calculators/categories/health/AdvancedHeartHealthCalculators2').then(m => ({ default: m.AdvancedAnkleBrachialIndexCalculator }))),
  'pao2-fio2-ratio': dynamic(() => import('@/components/calculators/categories/health/AdvancedHeartHealthCalculators5').then(m => ({ default: m.AdvancedPaO2FiO2Calculator }))),
  'tidal-volume-calculator': dynamic(() => import('@/components/calculators/categories/health/AdvancedHeartHealthCalculators5').then(m => ({ default: m.AdvancedTidalVolumeCalculator }))),
  'cardiovascular-risk': dynamic(() => import('@/components/calculators/categories/health/AdvancedHeartHealthCalculators2').then(m => ({ default: m.CardiovascularRiskCalculator }))),
  'respiration-rate-calculator': dynamic(() => import('@/components/calculators/categories/health/AdvancedHeartHealthCalculators2').then(m => ({ default: m.RespirationRateCalculator }))),
  'hrv-score-calculator': dynamic(() => import('@/components/calculators/categories/health/AdvancedHeartHealthCalculators2').then(m => ({ default: m.HRVScoreCalculator }))),
  'dehydration-risk': dynamic(() => import('@/components/calculators/categories/health/AdvancedHeartHealthCalculators3').then(m => ({ default: m.DehydrationRiskCalculator }))),
  'body-temperature-tracker': dynamic(() => import('@/components/calculators/categories/health/AdvancedHeartHealthCalculators3').then(m => ({ default: m.BodyTemperatureTracker }))),
  'blood-pressure-tracker': dynamic(() => import('@/components/calculators/categories/health/AdvancedHeartHealthCalculators3').then(m => ({ default: m.BloodPressureTracker }))),
  'resting-pulse-tracker': dynamic(() => import('@/components/calculators/categories/health/AdvancedHeartHealthCalculators3').then(m => ({ default: m.RestingPulseTracker }))),
  'stress-heart-impact': dynamic(() => import('@/components/calculators/categories/health/AdvancedHeartHealthCalculators3').then(m => ({ default: m.StressHeartImpactCalculator }))),
  'heart-rate-recovery': dynamic(() => import('@/components/calculators/categories/health/AdvancedHeartHealthCalculators3').then(m => ({ default: m.HeartRateRecoveryCalculator }))),
  'heart-rate-drift': dynamic(() => import('@/components/calculators/categories/health/AdvancedHeartHealthCalculators3').then(m => ({ default: m.HeartRateDriftCalculator }))),
  'orthostatic-heart-rate': dynamic(() => import('@/components/calculators/categories/health/AdvancedHeartHealthCalculators3').then(m => ({ default: m.OrthostaticHeartRateCalculator }))),
  'hrv-rmssd': dynamic(() => import('@/components/calculators/categories/health/AdvancedHeartHealthCalculators3').then(m => ({ default: m.HRVRMSSDCalculator }))),
  'hrv-sdnn': dynamic(() => import('@/components/calculators/categories/health/AdvancedHeartHealthCalculators3').then(m => ({ default: m.HRVSDNNCalculator }))),
  'blood-pressure-dip': dynamic(() => import('@/components/calculators/categories/health/AdvancedHeartHealthCalculators3').then(m => ({ default: m.BloodPressureDipCalculator }))),
  'arterial-compliance': dynamic(() => import('@/components/calculators/categories/health/AdvancedHeartHealthCalculators4').then(m => ({ default: m.ArterialComplianceCalculator }))),
  'vascular-age': dynamic(() => import('@/components/calculators/categories/health/AdvancedHeartHealthCalculators4').then(m => ({ default: m.VascularAgeCalculator }))),
  'framingham-heart-age': dynamic(() => import('@/components/calculators/categories/health/AdvancedHeartHealthCalculators4').then(m => ({ default: m.FraminghamHeartAgeCalculator }))),
  'vital-signs-summary': dynamic(() => import('@/components/calculators/categories/health/AdvancedHeartHealthCalculators4').then(m => ({ default: m.VitalSignsSummaryCalculator }))),
  'hydration-vitals-estimator': dynamic(() => import('@/components/calculators/categories/health/AdvancedHeartHealthCalculators4').then(m => ({ default: m.HydrationVitalsEstimator }))),
  'qrs-duration-calculator': dynamic(() => import('@/components/calculators/categories/health/AdvancedHeartHealthCalculators4').then(m => ({ default: m.QRSDurationCalculator }))),
  'ejection-fraction-estimate': dynamic(() => import('@/components/calculators/categories/health/AdvancedHeartHealthCalculators4').then(m => ({ default: m.EjectionFractionCalculator }))),
  'cardiac-index-calculator': dynamic(() => import('@/components/calculators/categories/health/AdvancedHeartHealthCalculators4').then(m => ({ default: m.CardiacIndexCalculator }))),
  'systemic-vascular-resistance': dynamic(() => import('@/components/calculators/categories/health/AdvancedHeartHealthCalculators4').then(m => ({ default: m.SystemicVascularResistanceCalculator }))),
  'pulse-oximetry-tracker': dynamic(() => import('@/components/calculators/categories/health/AdvancedHeartHealthCalculators4').then(m => ({ default: m.PulseOximetryTracker }))),
  'arterial-stiffness-index': dynamic(() => import('@/components/calculators/categories/health/AdvancedHeartHealthCalculators4').then(m => ({ default: m.ArterialStiffnessIndexCalculator }))),
  'ventricular-rate-calculator': dynamic(() => import('@/components/calculators/categories/health/AdvancedHeartHealthCalculators5').then(m => ({ default: m.VentricularRateCalculator }))),
  'atrial-fibrillation-rate': dynamic(() => import('@/components/calculators/categories/health/AdvancedHeartHealthCalculators5').then(m => ({ default: m.AtrialFibrillationRateCalculator }))),
  'pulse-deficit-calculator': dynamic(() => import('@/components/calculators/categories/health/AdvancedHeartHealthCalculators5').then(m => ({ default: m.PulseDeficitCalculator }))),
  'respiratory-quotient': dynamic(() => import('@/components/calculators/categories/health/AdvancedHeartHealthCalculators5').then(m => ({ default: m.RespiratoryQuotientCalculator }))),
  'minute-ventilation': dynamic(() => import('@/components/calculators/categories/health/AdvancedHeartHealthCalculators5').then(m => ({ default: m.MinuteVentilationCalculator }))),
  'alveolar-gas-equation': dynamic(() => import('@/components/calculators/categories/health/AdvancedHeartHealthCalculators5').then(m => ({ default: m.AlveolarGasEquationCalculator }))),
  'aa-gradient-calculator': dynamic(() => import('@/components/calculators/categories/health/AdvancedHeartHealthCalculators5').then(m => ({ default: m.AaGradientCalculator }))),
  'oxygen-delivery-calculator': dynamic(() => import('@/components/calculators/categories/health/AdvancedHeartHealthCalculators5').then(m => ({ default: m.OxygenDeliveryCalculator }))),
  'oxygen-consumption': dynamic(() => import('@/components/calculators/categories/health/AdvancedHeartHealthCalculators5').then(m => ({ default: m.OxygenConsumptionCalculator }))),
  'metabolic-cart-simulator': dynamic(() => import('@/components/calculators/categories/health/AdvancedHeartHealthCalculators5').then(m => ({ default: m.MetabolicCartSimulator }))),
  ...
  'body-frame-calculator': dynamic(() => import('@/components/calculators/categories/health/AdvancedWeightGoalCalculators2').then(m => ({ default: m.BodyFrameCalculator }))),
  'weight-goal-tracker': dynamic(() => import('@/components/calculators/categories/health/AdvancedWeightGoalCalculators2').then(m => ({ default: m.WeightGoalTracker }))),
  'weight-maintenance-planner': dynamic(() => import('@/components/calculators/categories/health/AdvancedWeightGoalCalculators2').then(m => ({ default: m.WeightMaintenancePlanner }))),
  'body-recomposition-calculator': dynamic(() => import('@/components/calculators/categories/health/AdvancedWeightGoalCalculators2').then(m => ({ default: m.BodyRecompositionPlanner }))),
  'weekly-calorie-budget': dynamic(() => import('@/components/calculators/categories/health/AdvancedWeightGoalCalculators2').then(m => ({ default: m.WeeklyCalorieBudget }))),
  'bmi-goal-tracker': dynamic(() => import('@/components/calculators/categories/health/AdvancedWeightGoalCalculators2').then(m => ({ default: m.BMIGoalTracker }))),
  'inch-loss-calculator': dynamic(() => import('@/components/calculators/categories/health/AdvancedWeightGoalCalculators3').then(m => ({ default: m.InchLossCalculator }))),
  'weight-loss-percentage': dynamic(() => import('@/components/calculators/categories/health/AdvancedWeightGoalCalculators3').then(m => ({ default: m.WeightLossPercentageCalculator }))),
  'calorie-cycling': dynamic(() => import('@/components/calculators/categories/health/AdvancedWeightGoalCalculators3').then(m => ({ default: m.CalorieCyclingPlanner }))),
  'cheat-meal-impact': dynamic(() => import('@/components/calculators/categories/health/AdvancedWeightGoalCalculators3').then(m => ({ default: m.CheatMealImpactCalculator }))),
  'weight-plateau-calculator': dynamic(() => import('@/components/calculators/categories/health/AdvancedWeightGoalCalculators3').then(m => ({ default: m.WeightPlateauCalculator }))),
  'progress-checkin': dynamic(() => import('@/components/calculators/categories/health/AdvancedWeightGoalCalculators3').then(m => ({ default: m.ProgressCheckinCalculator }))),
  'metabolism-tracker': dynamic(() => import('@/components/calculators/categories/health/AdvancedWeightGoalCalculators3').then(m => ({ default: m.MetabolismTracker }))),
  'weight-fluctuation-tracker': dynamic(() => import('@/components/calculators/categories/health/AdvancedWeightGoalCalculators3').then(m => ({ default: m.WeightFluctuationTracker }))),
  'body-measurement-tracker': dynamic(() => import('@/components/calculators/categories/health/AdvancedWeightGoalCalculators3').then(m => ({ default: m.BodyMeasurementTracker }))),
  'before-after-comparison': dynamic(() => import('@/components/calculators/categories/health/AdvancedWeightGoalCalculators3').then(m => ({ default: m.BeforeAfterComparison }))),
  'progress-photo-planner': dynamic(() => import('@/components/calculators/categories/health/AdvancedWeightGoalCalculators3').then(m => ({ default: m.ProgressPhotoPlanner }))),
  'weight-trend-analyzer': dynamic(() => import('@/components/calculators/categories/health/AdvancedWeightGoalCalculators3').then(m => ({ default: m.WeightTrendAnalyzer }))),
  'refeed-day-calculator': dynamic(() => import('@/components/calculators/categories/health/AdvancedWeightGoalCalculators3').then(m => ({ default: m.RefeedDayCalculator }))),
  'diet-break-planner': dynamic(() => import('@/components/calculators/categories/health/AdvancedWeightGoalCalculators4').then(m => ({ default: m.DietBreakPlanner }))),
  'reverse-diet-calculator': dynamic(() => import('@/components/calculators/categories/health/AdvancedWeightGoalCalculators4').then(m => ({ default: m.ReverseDietCalculator }))),
  'adaptive-thermogenesis': dynamic(() => import('@/components/calculators/categories/health/AdvancedWeightGoalCalculators4').then(m => ({ default: m.AdaptiveThermogenesisEstimator }))),
  'adaptive-tdee-calculator': dynamic(() => import('@/components/calculators/categories/health/AdvancedWeightGoalCalculators4').then(m => ({ default: m.AdaptiveTDEECalculator }))),
  'muscle-gain-predictor': dynamic(() => import('@/components/calculators/categories/health/AdvancedWeightGoalCalculators4').then(m => ({ default: m.MuscleGainPredictor }))),
  'weight-loss-rate': dynamic(() => import('@/components/calculators/categories/health/AdvancedWeightGoalCalculators4').then(m => ({ default: m.WeightLossRateCalculator }))),
  'calorie-banking': dynamic(() => import('@/components/calculators/categories/health/AdvancedWeightGoalCalculators4').then(m => ({ default: m.CalorieBankingCalculator }))),
  'diet-adherence': dynamic(() => import('@/components/calculators/categories/health/AdvancedWeightGoalCalculators4').then(m => ({ default: m.DietAdherenceCalculator }))),
  'binge-eating-risk': dynamic(() => import('@/components/calculators/categories/health/AdvancedWeightGoalCalculators4').then(m => ({ default: m.BingeEatingRiskCalculator }))),
  'emotional-eating': dynamic(() => import('@/components/calculators/categories/health/AdvancedWeightGoalCalculators4').then(m => ({ default: m.EmotionalEatingCalculator }))),
  'satiety-index': dynamic(() => import('@/components/calculators/categories/health/AdvancedWeightGoalCalculators4').then(m => ({ default: m.SatietyIndexCalculator }))),
  'hunger-scale': dynamic(() => import('@/components/calculators/categories/health/AdvancedWeightGoalCalculators5').then(m => ({ default: m.HungerScaleCalculator }))),
  'cravings-intensity': dynamic(() => import('@/components/calculators/categories/health/AdvancedWeightGoalCalculators5').then(m => ({ default: m.CravingsIntensityTracker }))),
  'maintenance-calories': dynamic(() => import('@/components/calculators/categories/health/AdvancedWeightGoalCalculators5').then(m => ({ default: m.MaintenanceCaloriesCalculator }))),
  'set-point-theory': dynamic(() => import('@/components/calculators/categories/health/AdvancedWeightGoalCalculators5').then(m => ({ default: m.SetPointTheoryEstimator }))),
  'metabolic-damage': dynamic(() => import('@/components/calculators/categories/health/AdvancedWeightGoalCalculators5').then(m => ({ default: m.MetabolicDamageEstimator }))),
  'reverse-dieting': dynamic(() => import('@/components/calculators/categories/health/AdvancedWeightGoalCalculators5').then(m => ({ default: m.ReverseDietingDurationCalc }))),
  'diet-break-freq': dynamic(() => import('@/components/calculators/categories/health/AdvancedWeightGoalCalculators5').then(m => ({ default: m.DietBreakFrequencyCalc }))),
  'fat-loss-predictor': dynamic(() => import('@/components/calculators/categories/health/AdvancedWeightGoalCalculators5').then(m => ({ default: m.FatLossPredictor }))),
  'skinny-fat-calculator': dynamic(() => import('@/components/calculators/categories/health/AdvancedWeightGoalCalculators5').then(m => ({ default: m.SkinnyFatCalculator }))),
  'genetic-potential-calculator': dynamic(() => import('@/components/calculators/categories/health/AdvancedWeightGoalCalculators5').then(m => ({ default: m.GeneticPotentialCalculator }))),
  'water-weight-calculator': dynamic(() => import('@/components/calculators/categories/health/AdvancedWeightGoalCalculators5').then(m => ({ default: m.WaterWeightCalculator }))),
  'glycogen-depletion': dynamic(() => import('@/components/calculators/categories/health/AdvancedWeightGoalCalculators5').then(m => ({ default: m.GlycogenDepletionCalculator }))),
  ...
  'pregnancy-calculator': dynamic(() => import('@/components/calculators/categories/health/AdvancedPregnancyCalculators2').then(m => ({ default: m.PregnancyCalculator }))),
  'fertility-window': dynamic(() => import('@/components/calculators/categories/health/AdvancedPregnancyCalculators2').then(m => ({ default: m.FertilityWindowCalculator }))),
  'pregnancy-week-calculator': dynamic(() => import('@/components/calculators/categories/health/AdvancedPregnancyCalculators2').then(m => ({ default: m.PregnancyWeekCalculator }))),
  'trimester-calculator': dynamic(() => import('@/components/calculators/categories/health/AdvancedPregnancyCalculators2').then(m => ({ default: m.TrimesterCalculator }))),
  'cycle-length-calculator': dynamic(() => import('@/components/calculators/categories/health/AdvancedPregnancyCalculators2').then(m => ({ default: m.CycleLengthCalculator }))),
  'period-tracker': dynamic(() => import('@/components/calculators/categories/health/AdvancedPregnancyCalculators2').then(m => ({ default: m.PeriodTracker }))),
  'conception-window': dynamic(() => import('@/components/calculators/categories/health/AdvancedPregnancyCalculators2').then(m => ({ default: m.ConceptionWindowEstimator }))),
  'ivf-due-date-calculator': dynamic(() => import('@/components/calculators/categories/health/AdvancedPregnancyCalculators2').then(m => ({ default: m.IVFDueDateCalculator }))),
  'pregnancy-calorie-calculator': dynamic(() => import('@/components/calculators/categories/health/AdvancedPregnancyCalculators2').then(m => ({ default: m.PregnancyCalorieCalculator }))),
  'pregnancy-bmi-calculator': dynamic(() => import('@/components/calculators/categories/health/AdvancedPregnancyCalculators2').then(m => ({ default: m.PregnancyBMICalculator }))),
  'fetal-growth-percentile': dynamic(() => import('@/components/calculators/categories/health/AdvancedPregnancyCalculators2').then(m => ({ default: m.FetalGrowthPercentileCalculator }))),
  'baby-kick-counter': dynamic(() => import('@/components/calculators/categories/health/AdvancedPregnancyCalculators3').then(m => ({ default: m.BabyKickCounter }))),
  'contraction-timer': dynamic(() => import('@/components/calculators/categories/health/AdvancedPregnancyCalculators3').then(m => ({ default: m.ContractionTimer }))),
  'breastfeeding-calorie': dynamic(() => import('@/components/calculators/categories/health/AdvancedPregnancyCalculators3').then(m => ({ default: m.BreastfeedingCalorieCalculator }))),
  'pregnancy-appointment-schedule': dynamic(() => import('@/components/calculators/categories/health/AdvancedPregnancyCalculators3').then(m => ({ default: m.PregnancyAppointmentSchedule }))),
  'fertility-score-calculator': dynamic(() => import('@/components/calculators/categories/health/AdvancedPregnancyCalculators3').then(m => ({ default: m.FertilityScoreCalculator }))),
  'luteal-phase-calculator': dynamic(() => import('@/components/calculators/categories/health/AdvancedPregnancyCalculators3').then(m => ({ default: m.LutealPhaseCalculator }))),
  'follicular-phase-tracker': dynamic(() => import('@/components/calculators/categories/health/AdvancedPregnancyCalculators3').then(m => ({ default: m.FollicularPhaseTracker }))),
  'cervical-mucus-tracker': dynamic(() => import('@/components/calculators/categories/health/AdvancedPregnancyCalculators3').then(m => ({ default: m.CervicalMucusTracker }))),
  'basal-body-temp-tracker': dynamic(() => import('@/components/calculators/categories/health/AdvancedPregnancyCalculators3').then(m => ({ default: m.BasalBodyTempTracker }))),
  'pregnancy-test-timing': dynamic(() => import('@/components/calculators/categories/health/AdvancedPregnancyCalculators3').then(m => ({ default: m.PregnancyTestTimingCalculator }))),
  'fundal-height-calculator': dynamic(() => import('@/components/calculators/categories/health/AdvancedPregnancyCalculators3').then(m => ({ default: m.FundalHeightCalculator }))),
  'pregnancy-blood-volume': dynamic(() => import('@/components/calculators/categories/health/AdvancedPregnancyCalculators3').then(m => ({ default: m.PregnancyBloodVolumeCalculator }))),
  'morning-sickness-tracker': dynamic(() => import('@/components/calculators/categories/health/AdvancedPregnancyCalculators3').then(m => ({ default: m.MorningSicknessTracker }))),
  'naegeles-rule-calculator': dynamic(() => import('@/components/calculators/categories/health/AdvancedPregnancyCalculators4').then(m => ({ default: m.NaegelesRuleCalculator }))),
  'pregnancy-milestones': dynamic(() => import('@/components/calculators/categories/health/AdvancedPregnancyCalculators4').then(m => ({ default: m.PregnancyMilestonesTracker }))),
  'amniotic-fluid-index': dynamic(() => import('@/components/calculators/categories/health/AdvancedPregnancyCalculators4').then(m => ({ default: m.AmnioticFluidIndexCalculator }))),
  'biophysical-profile-score': dynamic(() => import('@/components/calculators/categories/health/AdvancedPregnancyCalculators4').then(m => ({ default: m.BiophysicalProfileCalculator }))),
  'bishops-score-calculator': dynamic(() => import('@/components/calculators/categories/health/AdvancedPregnancyCalculators4').then(m => ({ default: m.BishopsScoreCalculator }))),
  'apgar-score-calculator': dynamic(() => import('@/components/calculators/categories/health/AdvancedPregnancyCalculators4').then(m => ({ default: m.ApgarScoreCalculator }))),
  'breastmilk-storage-guide': dynamic(() => import('@/components/calculators/categories/health/AdvancedPregnancyCalculators4').then(m => ({ default: m.BreastmilkStorageGuide }))),
  'newborn-feeding-schedule': dynamic(() => import('@/components/calculators/categories/health/AdvancedPregnancyCalculators4').then(m => ({ default: m.NewbornFeedingSchedule }))),
  'postpartum-recovery-tracker': dynamic(() => import('@/components/calculators/categories/health/AdvancedPregnancyCalculators4').then(m => ({ default: m.PostpartumRecoveryTracker }))),
  'pms-symptom-tracker': dynamic(() => import('@/components/calculators/categories/health/AdvancedPregnancyCalculators4').then(m => ({ default: m.PMSSymptomTracker }))),
  'implantation-calculator': dynamic(() => import('@/components/calculators/categories/health/AdvancedPregnancyCalculators4').then(m => ({ default: m.ImplantationCalculator }))),
  'doula-cost': dynamic(() => import('@/components/calculators/categories/health/AdvancedPregnancyCalculators4').then(m => ({ default: m.DoulaCostEstimator }))),
  'midwife-cost': dynamic(() => import('@/components/calculators/categories/health/AdvancedPregnancyCalculators4').then(m => ({ default: m.MidwifeCostEstimator }))),
  'hospital-bag': dynamic(() => import('@/components/calculators/categories/health/AdvancedPregnancyCalculators4').then(m => ({ default: m.HospitalBagChecklist }))),
  'baby-name-numerology': dynamic(() => import('@/components/calculators/categories/health/AdvancedPregnancyCalculators4').then(m => ({ default: m.BabyNameNumerology }))),
  'chinese-gender': dynamic(() => import('@/components/calculators/categories/health/AdvancedPregnancyCalculators5').then(m => ({ default: m.ChineseGenderPredictor }))),
  'mayan-gender': dynamic(() => import('@/components/calculators/categories/health/AdvancedPregnancyCalculators5').then(m => ({ default: m.MayanGenderPredictor }))),
  'ramzi-theory': dynamic(() => import('@/components/calculators/categories/health/AdvancedPregnancyCalculators5').then(m => ({ default: m.RamziTheoryPredictor }))),
  'nub-theory': dynamic(() => import('@/components/calculators/categories/health/AdvancedPregnancyCalculators5').then(m => ({ default: m.NubTheoryPredictor }))),
  'skull-theory': dynamic(() => import('@/components/calculators/categories/health/AdvancedPregnancyCalculators5').then(m => ({ default: m.SkullTheoryPredictor }))),
  'baby-eye-color': dynamic(() => import('@/components/calculators/categories/health/AdvancedPregnancyCalculators5').then(m => ({ default: m.BabyEyeColorPredictor }))),
  'baby-hair-color': dynamic(() => import('@/components/calculators/categories/health/AdvancedPregnancyCalculators5').then(m => ({ default: m.BabyHairColorPredictor }))),
  'twin-probability': dynamic(() => import('@/components/calculators/categories/health/AdvancedPregnancyCalculators5').then(m => ({ default: m.TwinProbabilityCalculator }))),
  'vbac-success': dynamic(() => import('@/components/calculators/categories/health/AdvancedPregnancyCalculators5').then(m => ({ default: m.VBACSuccessCalculator }))),
  'labor-pain': dynamic(() => import('@/components/calculators/categories/health/AdvancedPregnancyCalculators5').then(m => ({ default: m.LaborPainSimulator }))),
  'contraction-intensity': dynamic(() => import('@/components/calculators/categories/health/AdvancedPregnancyCalculators5').then(m => ({ default: m.ContractionIntensityCalculator }))),
  'pregnancy-due-date': dynamic(() => import('@/components/calculators/categories/health/AdvancedPregnancyCalculators').then(m => ({ default: m.DueDateCalculator }))),
  'menstrual-cycle': dynamic(() => import('@/components/calculators/categories/health/AdvancedBiologicalHealthCalculators').then(m => ({ default: m.MenstrualCycleCalculator }))),
  'fetal-development': dynamic(() => import('@/components/calculators/categories/health/AdvancedBiologicalHealthCalculators').then(m => ({ default: m.FetalDevelopmentTimeline }))),
  'vaccination-schedule': dynamic(() => import('@/components/calculators/categories/health/AdvancedBiologicalHealthCalculators').then(m => ({ default: m.VaccinationSchedulePlanner }))),

  // ─── Health - Sleep & Lifestyle ────────────────────────────────────────────
  'sleep-cycle-calculator': dynamic(() => import('@/components/calculators/categories/health/AdvancedSleepLifestyleCalculators').then(m => ({ default: m.SleepCycleREMCalculator }))),
  'sleep-cycle-optimizer': dynamic(() => import('@/components/calculators/categories/health/AdvancedSleepLifestyleCalculators').then(m => ({ default: m.SleepCycleREMCalculator }))),
  'sleep-debt-calculator': dynamic(() => import('@/components/calculators/categories/health/AdvancedSleepLifestyleCalculators').then(m => ({ default: m.SleepDebtCalculator }))),
  'sleep-efficiency-calculator': dynamic(() => import('@/components/calculators/categories/health/AdvancedSleepLifestyleCalculators2').then(m => ({ default: m.SleepEfficiencyAdvancedCalculator }))),
  'caffeine-calculator': dynamic(() => import('@/components/calculators/categories/health/AdvancedSleepLifestyleCalculators').then(m => ({ default: m.CaffeineSleepCalculator }))),
  'jet-lag-calculator': dynamic(() => import('@/components/calculators/categories/health/AdvancedSleepLifestyleCalculators').then(m => ({ default: m.JetLagRecoveryCalculator }))),
  'jet-lag-recovery': dynamic(() => import('@/components/calculators/categories/health/AdvancedSleepLifestyleCalculators').then(m => ({ default: m.JetLagRecoveryCalculator }))),
  'smoke-free-calculator': dynamic(() => import('@/components/calculators/categories/health/AdvancedSleepLifestyleCalculators2').then(m => ({ default: m.SmokeFreeProgressCalculator }))),
  'nap-calculator': dynamic(() => import('@/components/calculators/categories/health/AdvancedSleepLifestyleCalculators').then(m => ({ default: m.NapTimingCalculator }))),
  'alcohol-calorie-calculator-basic': dynamic(() => import('@/components/calculators/categories/health/AdvancedSleepCalculators').then(m => ({ default: m.AlcoholCalorieCalculator }))),  // basic version kept as fallback
  'stress-level-calculator': dynamic(() => import('@/components/calculators/categories/health/AdvancedSleepLifestyleCalculators').then(m => ({ default: m.StressLevelCalculator }))),
  'screen-time-calculator': dynamic(() => import('@/components/calculators/categories/health/AdvancedSleepLifestyleCalculators').then(m => ({ default: m.ScreenTimeCalculator }))),
  'circadian-rhythm-calculator': dynamic(() => import('@/components/calculators/categories/health/AdvancedSleepLifestyleCalculators').then(m => ({ default: m.CircadianRhythmPlanner }))),
  'circadian-rhythm': dynamic(() => import('@/components/calculators/categories/health/AdvancedSleepLifestyleCalculators').then(m => ({ default: m.CircadianRhythmPlanner }))),
  'nap-time-optimizer': dynamic(() => import('@/components/calculators/categories/health/AdvancedSleepLifestyleCalculators').then(m => ({ default: m.NapTimingCalculator }))),
  'blue-light-schedule': dynamic(() => import('@/components/calculators/categories/health/AdvancedSleepLifestyleCalculators').then(m => ({ default: m.BlueLightScheduleCalculator }))),
  'meditation-timer': dynamic(() => import('@/components/calculators/categories/health/AdvancedSleepLifestyleCalculators').then(m => ({ default: m.MeditationTimerCalculator }))),
  'breathing-exercise-timer': dynamic(() => import('@/components/calculators/categories/health/AdvancedSleepLifestyleCalculators').then(m => ({ default: m.BreathingExerciseCalculator }))),
  'alcohol-sleep-impact': dynamic(() => import('@/components/calculators/categories/health/AdvancedSleepLifestyleCalculators').then(m => ({ default: m.AlcoholSleepImpactCalculator }))),
  'nicotine-sleep-impact': dynamic(() => import('@/components/calculators/categories/health/AdvancedSleepLifestyleCalculators2').then(m => ({ default: m.NicotineSleepImpactCalculator }))),
  'daily-habit-score': dynamic(() => import('@/components/calculators/categories/health/AdvancedSleepLifestyleCalculators2').then(m => ({ default: m.DailyHabitScoreCalculator }))),
  'mindfulness-score': dynamic(() => import('@/components/calculators/categories/health/AdvancedSleepLifestyleCalculators2').then(m => ({ default: m.MindfulnessScoreCalculator }))),
  'sobriety-calculator': dynamic(() => import('@/components/calculators/categories/health/AdvancedSleepLifestyleCalculators2').then(m => ({ default: m.SobrietyCalculator }))),
  'fitness-streak': dynamic(() => import('@/components/calculators/categories/health/AdvancedSleepLifestyleCalculators2').then(m => ({ default: m.FitnessStreakCalculator }))),
  'burnout-risk-calculator': dynamic(() => import('@/components/calculators/categories/health/AdvancedSleepLifestyleCalculators2').then(m => ({ default: m.BurnoutRiskCalculator }))),
  'hydration-reminder': dynamic(() => import('@/components/calculators/categories/health/AdvancedSleepLifestyleCalculators2').then(m => ({ default: m.HydrationReminderCalculator }))),
  'bedtime-reminder': dynamic(() => import('@/components/calculators/categories/health/AdvancedSleepLifestyleCalculators2').then(m => ({ default: m.BedtimeReminderCalculator }))),
  'sleep-quality-score': dynamic(() => import('@/components/calculators/categories/health/AdvancedSleepLifestyleCalculators2').then(m => ({ default: m.SleepQualityScoreCalculator }))),
  'power-nap-timer': dynamic(() => import('@/components/calculators/categories/health/AdvancedSleepLifestyleCalculators2').then(m => ({ default: m.PowerNapTimerCalculator }))),
  'polyphasic-sleep-planner': dynamic(() => import('@/components/calculators/categories/health/AdvancedSleepLifestyleCalculators2').then(m => ({ default: m.PolyphasicSleepPlanner }))),
  'shift-work-sleep-planner': dynamic(() => import('@/components/calculators/categories/health/AdvancedSleepLifestyleCalculators2').then(m => ({ default: m.ShiftWorkSleepPlanner }))),
  'sleep-onset-latency': dynamic(() => import('@/components/calculators/categories/health/AdvancedSleepLifestyleCalculators3').then(m => ({ default: m.SleepOnsetLatencyCalculator }))),
  'wake-after-sleep-onset': dynamic(() => import('@/components/calculators/categories/health/AdvancedSleepLifestyleCalculators3').then(m => ({ default: m.WASOCalculator }))),
  'sleep-fragmentation-index': dynamic(() => import('@/components/calculators/categories/health/AdvancedSleepLifestyleCalculators3').then(m => ({ default: m.SleepFragmentationCalculator }))),
  'chronotype-calculator': dynamic(() => import('@/components/calculators/categories/health/AdvancedSleepLifestyleCalculators3').then(m => ({ default: m.ChronotypeCalculator }))),
  'social-jetlag-calculator': dynamic(() => import('@/components/calculators/categories/health/AdvancedSleepLifestyleCalculators3').then(m => ({ default: m.SocialJetlagCalculator }))),
  'melatonin-timing-calculator': dynamic(() => import('@/components/calculators/categories/health/AdvancedSleepLifestyleCalculators3').then(m => ({ default: m.MelatoninTimingCalculator }))),
  'light-exposure-tracker': dynamic(() => import('@/components/calculators/categories/health/AdvancedSleepLifestyleCalculators3').then(m => ({ default: m.LightExposureCalculator }))),
  'darkness-exposure-planner': dynamic(() => import('@/components/calculators/categories/health/AdvancedSleepLifestyleCalculators3').then(m => ({ default: m.DarknessExposurePlanner }))),
  'exercise-sleep-timing': dynamic(() => import('@/components/calculators/categories/health/AdvancedSleepLifestyleCalculators3').then(m => ({ default: m.ExerciseSleepTimingCalculator }))),
  'dinner-bedtime-gap': dynamic(() => import('@/components/calculators/categories/health/AdvancedSleepLifestyleCalculators3').then(m => ({ default: m.DinnerBedtimeGapCalculator }))),
  'bedroom-temp-optimizer': dynamic(() => import('@/components/calculators/categories/health/AdvancedSleepLifestyleCalculators3').then(m => ({ default: m.BedroomTempOptimizer }))),
  'noise-sleep-impact': dynamic(() => import('@/components/calculators/categories/health/AdvancedSleepLifestyleCalculators3').then(m => ({ default: m.NoiseSleepImpactCalculator }))),
  'weekend-sleep-calculator': dynamic(() => import('@/components/calculators/categories/health/AdvancedSleepLifestyleCalculators4').then(m => ({ default: m.WeekendSleepCalculator }))),
  'sleep-pressure-calculator': dynamic(() => import('@/components/calculators/categories/health/AdvancedSleepLifestyleCalculators4').then(m => ({ default: m.SleepPressureCalculator }))),
  'adenosine-clearance': dynamic(() => import('@/components/calculators/categories/health/AdvancedSleepLifestyleCalculators4').then(m => ({ default: m.AdenosineClearanceCalculator }))),
  'sleep-hygiene-score': dynamic(() => import('@/components/calculators/categories/health/AdvancedSleepLifestyleCalculators4').then(m => ({ default: m.SleepHygieneScoreCalculator }))),
  'sleep-inertia': dynamic(() => import('@/components/calculators/categories/health/AdvancedSleepLifestyleCalculators4').then(m => ({ default: m.SleepInertiaCalculator }))),
  'lucid-dreaming': dynamic(() => import('@/components/calculators/categories/health/AdvancedSleepLifestyleCalculators4').then(m => ({ default: m.LucidDreamingCalculator }))),
  'dream-recall': dynamic(() => import('@/components/calculators/categories/health/AdvancedSleepLifestyleCalculators4').then(m => ({ default: m.DreamRecallTracker }))),
  'sleep-walking': dynamic(() => import('@/components/calculators/categories/health/AdvancedSleepLifestyleCalculators4').then(m => ({ default: m.SleepwalkingRiskCalculator }))),
  'sleep-talking': dynamic(() => import('@/components/calculators/categories/health/AdvancedSleepLifestyleCalculators4').then(m => ({ default: m.SleepTalkingRiskCalculator }))),
  'sleep-paralysis': dynamic(() => import('@/components/calculators/categories/health/AdvancedSleepLifestyleCalculators4').then(m => ({ default: m.SleepParalysisRiskCalculator }))),
  ...
  'stroke-risk-calculator': dynamic(() => import('@/components/calculators/categories/health/AdvancedDiseaseRiskCalculators2').then(m => ({ default: m.StrokeRiskCalculator }))),
  'metabolic-syndrome-calculator': dynamic(() => import('@/components/calculators/categories/health/AdvancedDiseaseRiskCalculators2').then(m => ({ default: m.MetabolicSyndromeCalculator }))),
  'bone-density-calculator': dynamic(() => import('@/components/calculators/categories/health/AdvancedDiseaseRiskCalculators2').then(m => ({ default: m.BoneDensityCalculator }))),
  'kidney-function-calculator': dynamic(() => import('@/components/calculators/categories/health/AdvancedDiseaseRiskCalculators2').then(m => ({ default: m.KidneyFunctionCalculator }))),
  'hypertension-risk-calculator': dynamic(() => import('@/components/calculators/categories/health/AdvancedDiseaseRiskCalculators2').then(m => ({ default: m.HypertensionRiskEstimator }))),
  'sleep-apnea-risk-calculator': dynamic(() => import('@/components/calculators/categories/health/AdvancedDiseaseRiskCalculators2').then(m => ({ default: m.SleepApneaRiskEstimator }))),
  'fatty-liver-risk-calculator': dynamic(() => import('@/components/calculators/categories/health/AdvancedDiseaseRiskCalculators2').then(m => ({ default: m.FattyLiverRiskEstimator }))),
  'anemia-risk-calculator': dynamic(() => import('@/components/calculators/categories/health/AdvancedDiseaseRiskCalculators2').then(m => ({ default: m.AnemiaRiskEstimator }))),
  'thyroid-risk-calculator': dynamic(() => import('@/components/calculators/categories/health/AdvancedDiseaseRiskCalculators3').then(m => ({ default: m.ThyroidRiskCalculator }))),
  'kidney-stone-risk': dynamic(() => import('@/components/calculators/categories/health/AdvancedDiseaseRiskCalculators3').then(m => ({ default: m.KidneyStoneRiskCalculator }))),
  'liver-function-score': dynamic(() => import('@/components/calculators/categories/health/AdvancedDiseaseRiskCalculators3').then(m => ({ default: m.LiverFunctionScoreCalculator }))),
  'immune-score-calculator': dynamic(() => import('@/components/calculators/categories/health/AdvancedDiseaseRiskCalculators3').then(m => ({ default: m.ImmuneScoreCalculator }))),
  'vitamin-deficiency-check': dynamic(() => import('@/components/calculators/categories/health/AdvancedDiseaseRiskCalculators3').then(m => ({ default: m.VitaminDeficiencyCalculator }))),
  'asthma-control-score': dynamic(() => import('@/components/calculators/categories/health/AdvancedDiseaseRiskCalculators4').then(m => ({ default: m.AsthmaControlScoreCalculator }))),
  'allergy-symptom-score': dynamic(() => import('@/components/calculators/categories/health/AdvancedDiseaseRiskCalculators4').then(m => ({ default: m.AllergySymptomScoreCalculator }))),
  'migraine-trigger-tracker': dynamic(() => import('@/components/calculators/categories/health/AdvancedDiseaseRiskCalculators4').then(m => ({ default: m.MigraneTriggerTrackerCalculator }))),
  'inflammation-crp-interpreter': dynamic(() => import('@/components/calculators/categories/health/AdvancedDiseaseRiskCalculators4').then(m => ({ default: m.CRPInterpreterCalculator }))),
  'framingham-risk-score': dynamic(() => import('@/components/calculators/categories/health/AdvancedDiseaseRiskCalculators4').then(m => ({ default: m.FraminghamRiskScoreCalculator }))),
  'ascvd-risk-calculator': dynamic(() => import('@/components/calculators/categories/health/AdvancedDiseaseRiskCalculators4').then(m => ({ default: m.ASCVDRiskCalculator }))),
  'chads2-vasc-score': dynamic(() => import('@/components/calculators/categories/health/AdvancedDiseaseRiskCalculators5').then(m => ({ default: m.CHADS2VASCScoreCalculator }))),
  'has-bled-score': dynamic(() => import('@/components/calculators/categories/health/AdvancedDiseaseRiskCalculators5').then(m => ({ default: m.HASBLEDScoreCalculator }))),
  'wells-score-dvt': dynamic(() => import('@/components/calculators/categories/health/AdvancedDiseaseRiskCalculators5').then(m => ({ default: m.WellsScoreDVTCalculator }))),
  'wells-score-pe': dynamic(() => import('@/components/calculators/categories/health/AdvancedDiseaseRiskCalculators5').then(m => ({ default: m.WellsScorePECalculator }))),
  'perc-rule-calculator': dynamic(() => import('@/components/calculators/categories/health/AdvancedDiseaseRiskCalculators5').then(m => ({ default: m.PERCRuleCalculator }))),
  'gout-risk': dynamic(() => import('@/components/calculators/categories/health/AdvancedDiseaseRiskCalculators6').then(m => ({ default: m.GoutRiskCalculator }))),
  'osteoarthritis-risk': dynamic(() => import('@/components/calculators/categories/health/AdvancedDiseaseRiskCalculators6').then(m => ({ default: m.OsteoarthritisRiskCalculator }))),
  'rheumatoid-arthritis': dynamic(() => import('@/components/calculators/categories/health/AdvancedDiseaseRiskCalculators6').then(m => ({ default: m.RheumatoidArthritisRiskCalculator }))),
  'lupus-risk': dynamic(() => import('@/components/calculators/categories/health/AdvancedDiseaseRiskCalculators6').then(m => ({ default: m.LupusRiskCalculator }))),
  'multiple-sclerosis': dynamic(() => import('@/components/calculators/categories/health/AdvancedDiseaseRiskCalculators6').then(m => ({ default: m.MultipleSclerosisRiskCalculator }))),
  'parkinsons-risk': dynamic(() => import('@/components/calculators/categories/health/AdvancedDiseaseRiskCalculators7').then(m => ({ default: m.ParkinsonsRiskCalculator }))),
  'alzheimers-risk': dynamic(() => import('@/components/calculators/categories/health/AdvancedDiseaseRiskCalculators7').then(m => ({ default: m.AlzheimersRiskCalculator }))),
  'dementia-risk': dynamic(() => import('@/components/calculators/categories/health/AdvancedDiseaseRiskCalculators7').then(m => ({ default: m.DementiaRiskCalculator }))),
  'glaucoma-risk': dynamic(() => import('@/components/calculators/categories/health/AdvancedDiseaseRiskCalculators7').then(m => ({ default: m.GlaucomaRiskCalculator }))),
  'curb-65-score': dynamic(() => import('@/components/calculators/categories/health/AdvancedDiseaseRiskCalculators7').then(m => ({ default: m.CURB65ScoreCalculator }))),
  'sofa-score-calculator': dynamic(() => import('@/components/calculators/categories/health/AdvancedDiseaseRiskCalculators7').then(m => ({ default: m.SOFAScoreCalculator }))),
  'qsofa-score': dynamic(() => import('@/components/calculators/categories/health/AdvancedDiseaseRiskCalculators8').then(m => ({ default: m.QSOFAScoreCalculator }))),
  'sirs-criteria-calculator': dynamic(() => import('@/components/calculators/categories/health/AdvancedDiseaseRiskCalculators8').then(m => ({ default: m.SIRSCriteriaCalculator }))),
  'apache-ii-score': dynamic(() => import('@/components/calculators/categories/health/AdvancedDiseaseRiskCalculators8').then(m => ({ default: m.APACHEIIScoreCalculator }))),
  'meld-score-calculator': dynamic(() => import('@/components/calculators/categories/health/AdvancedDiseaseRiskCalculators8').then(m => ({ default: m.MELDScoreCalculator }))),
  'child-pugh-score': dynamic(() => import('@/components/calculators/categories/health/AdvancedDiseaseRiskCalculators8').then(m => ({ default: m.ChildPughScoreCalculator }))),
  'urine-protein-creatinine': dynamic(() => import('@/components/calculators/categories/health/AdvancedDiseaseRiskCalculators8').then(m => ({ default: m.UrineProteinCreatinineCalculator }))),
  ...
  'body-shape-index': dynamic(() => import('@/components/calculators/categories/health/AdvancedBodyMeasurementCalculators').then(m => ({ default: m.BodyShapeIndexCalculator }))),
  'ffmi-calculator': dynamic(() => import('@/components/calculators/categories/health/AdvancedBodyMeasurementCalculators').then(m => ({ default: m.FFMICalculator }))),
  'ideal-body-fat': dynamic(() => import('@/components/calculators/categories/health/AdvancedBodyMeasurementCalculators').then(m => ({ default: m.IdealBodyFatCalculator }))),
  'chest-waist-ratio': dynamic(() => import('@/components/calculators/categories/health/AdvancedBodyMeasurementCalculators').then(m => ({ default: m.ChestWaistRatioCalculator }))),
  'arm-span-height-ratio': dynamic(() => import('@/components/calculators/categories/health/AdvancedBodyMeasurementCalculators').then(m => ({ default: m.ArmSpanHeightRatioCalculator }))),
  'mid-upper-arm-circumference': dynamic(() => import('@/components/calculators/categories/health/AdvancedBodyMeasurementCalculators').then(m => ({ default: m.MidUpperArmCircumferenceCalculator }))),
  'calf-circumference': dynamic(() => import('@/components/calculators/categories/health/AdvancedBodyMeasurementCalculators').then(m => ({ default: m.CalfCircumferenceCalculator }))),
  'thigh-circumference-measure': dynamic(() => import('@/components/calculators/categories/health/AdvancedBodyMeasurementCalculators').then(m => ({ default: m.ThighCircumferenceCalculator }))),
  'forearm-circumference': dynamic(() => import('@/components/calculators/categories/health/AdvancedBodyMeasurementCalculators').then(m => ({ default: m.ForearmCircumferenceCalculator }))),
  'shoulder-width-calculator': dynamic(() => import('@/components/calculators/categories/health/AdvancedBodyMeasurementCalculators').then(m => ({ default: m.ShoulderWidthCalculator }))),
  'torso-length-measure': dynamic(() => import('@/components/calculators/categories/health/AdvancedBodyMeasurementCalculators').then(m => ({ default: m.TorsoLengthCalculator }))),
  'leg-length-calculator': dynamic(() => import('@/components/calculators/categories/health/AdvancedBodyMeasurementCalculators').then(m => ({ default: m.LegLengthCalculator }))),
  'sitting-height-ratio': dynamic(() => import('@/components/calculators/categories/health/AdvancedBodyMeasurementCalculators').then(m => ({ default: m.SittingHeightRatioCalculator }))),
  'bmi-prime-calculator': dynamic(() => import('@/components/calculators/categories/health/AdvancedBodyMeasurementCalculators').then(m => ({ default: m.BMIPrimeCalculator }))),
  'corpulence-index': dynamic(() => import('@/components/calculators/categories/health/AdvancedBodyMeasurementCalculators').then(m => ({ default: m.CorpulenceIndexCalculator }))),
  'body-roundness-index': dynamic(() => import('@/components/calculators/categories/health/AdvancedBodyMeasurementCalculators').then(m => ({ default: m.BodyRoundnessIndexCalculator }))),
  'conicity-index': dynamic(() => import('@/components/calculators/categories/health/AdvancedBodyMeasurementCalculators').then(m => ({ default: m.ConicityIndexCalculator }))),
  'sagittal-abdominal-diameter': dynamic(() => import('@/components/calculators/categories/health/AdvancedBodyMeasurementCalculators').then(m => ({ default: m.SagittalAbdominalDiameterCalculator }))),
  'wrist-circumference': dynamic(() => import('@/components/calculators/categories/health/AdvancedBodyMeasurementCalculators').then(m => ({ default: m.WristCircumferenceCalculator }))),
  'ankle-circumference': dynamic(() => import('@/components/calculators/categories/health/AdvancedBodyMeasurementCalculators').then(m => ({ default: m.AnkleCircumferenceCalculator }))),
  'bicep-circumference': dynamic(() => import('@/components/calculators/categories/health/AdvancedBodyMeasurementCalculators').then(m => ({ default: m.BicepCircumferenceCalculator }))),
  'tricep-skinfold': dynamic(() => import('@/components/calculators/categories/health/AdvancedBodyMeasurementCalculators').then(m => ({ default: m.TricepSkinfoldCalculator }))),
  'subscapular-skinfold': dynamic(() => import('@/components/calculators/categories/health/AdvancedBodyMeasurementCalculators').then(m => ({ default: m.SubscapularSkinfoldCalculator }))),
